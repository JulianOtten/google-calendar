...
4. Open a command prompt in your workspace, shift + right click and open a terminal. Enter the following command:
4. npm install googleapis google-auth-library@0.* mysql2 -S
